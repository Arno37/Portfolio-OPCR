...
const about = {
  ...
  imageSize: 160,
  message:
    "Je me suis lancé un défi audacieux en effectuant une reconversion professionnelle dans le développement web. Animé par une soif d'apprentissage et une curiosité aigüe, j'ai décidé d'explorer cet univers fascinant. J'ai donc entrepris une formation intensive de développeur web chez Openclassrooms. Au cours de cette aventure, j'ai grandement apprécié prendre part à des projets captivants et mettre en pratique mes compétences en créant une série de projets innovants, tous réunis dans mon portfolio."
};
